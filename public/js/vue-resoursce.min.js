...
!function (t, e) {
    ...
    "use strict";
    function t(t) {
        this.state = M, this.value = void 0, this.deferred = [];
        var e = this;
        try {
            t(function (t) {
                e.resolve(t)
    ...
    function m(t, e, n) {
        return n = n || {}, a(n) && (n = n.call(e)), v(t.bind({$vm: e, $options: n}), t, {$options: n})
    }

    function y(t, e) {
        var n, o;
        if (tt(t))for (n = 0; n < t.length; n++)e.call(t[n], t[n], n); else if (f(t))for (o in t)z.call(t, o) && e.call(t[o], t[o], o);
        return t
    }
    ...
    function w(t, e, n) {
        for (var o in e)n && (p(e[o]) || tt(e[o])) ? (p(e[o]) && !p(t[o]) && (t[o] = {}), tt(e[o]) && !tt(t[o]) && (t[o] = []), w(t[o], e[o], n)) : void 0 !== e[o] && (t[o] = e[o])
    }
    ...
    function C(t, e) {
        ...
        return c(t) && (r = {
            url: t,
            params: e
        }), r = v({}, C.options, o.$options, r), C.transforms.forEach(function (t) {
            n = A(t, n, o.$vm)
        }), n(r)
    }
    ...
    function B(t) {
        var n = this || {}, r = yt(n.$vm);
        return b(t || {}, n.$options, B.options), B.interceptors.forEach(function (t) {
            r.use(t)
    ...
    function D(t) {
        D.installed || (Z(t), t.url = C, t.http = B, t.resource = q, t.Promise = e, Object.defineProperties(t.prototype, {
            $url: {
                get: function () {
    ...
    X.resolve = function (t) {
        ...
        var t = this;
        r(function () {
            if (t.state !== M)for (; t.deferred.length;) {
                var e = t.deferred.shift(), n = e[0], o = e[1], r = e[2], i = e[3];
                try {
                    t.state === F ? r("function" == typeof n ? n.call(void 0, t.value) : t.value) : t.state === J && ("function" == typeof o ? r(o.call(void 0, t.value)) : i(t.value))
                } catch (t) {
                    i(t)
                }
            }
    ...
    var G = !1, V = {}, _ = {}, z = _.hasOwnProperty, K = [], Q = K.slice, Y = "undefined" != typeof window, Z = function (t) {
        ...
        var n = Object.keys(C.options.params), o = {}, r = e(t);
        return y(t.params, function (t, e) {
            n.indexOf(e) === -1 && (o[e] = t)
        }), o = C.params(o), o && (r += (r.indexOf("?") == -1 ? "?" : "&") + o), r
    }, rt = function (t) {
    ...
    C.options = {url: "", root: null, params: {}}, C.transforms = [rt, ot, nt], C.params = function (t) {
    ...
    var it = function (t) {
        ...
        if (Y) {
            var n = C.parse(location.href), o = C.parse(t.getUrl());
            o.protocol === n.protocol && o.host === n.host || (t.crossOrigin = !0, t.emulateHTTP = !1, ut || (t.client = it))
        }
        e()
    }, ct = function (t, e) {
        l(t.body) ? t.headers.delete("Content-Type") : (f(t.body) || tt(t.body)) && (t.emulateJSON ? (t.body = C.params(t.body), t.headers.set("Content-Type", "application/x-www-form-urlencoded")) : t.body = JSON.stringify(t.body)), e(function (t) {
            ...
            }), t.bodyText ? d(t.text(), function (e) {
                var n = t.headers.get("Content-Type") || "";
                if (0 === n.indexOf("application/json") || U(e))try {
                    t.body = JSON.parse(e)
                } catch (e) {
                    t.body = null
                } else t.body = e;
        ...
        "JSONP" == t.method && (t.client = at), e()
    }, pt = function (t, e) {
        a(t.before) && t.before.call(this, t), e()
    }, ht = function (t, e) {
        t.emulateHTTP && /^(PUT|PATCH|DELETE)$/i.test(t.method) && (t.headers.set("X-HTTP-Method-Override", t.method), t.method = "POST"), e()
    }, lt = function (t, e) {
        var n = et({}, B.headers.common, t.crossOrigin ? {} : B.headers.custom, B.headers[u(t.method)]);
        y(n, function (e, n) {
            t.headers.has(n) || t.headers.set(n, e)
        }), e()
    }, dt = "undefined" != typeof Blob && "undefined" != typeof FileReader, mt = function (t) {
        return new e(function (e) {
            ...
            t.abort = function () {
                return n.abort()
            }, t.progress && ("GET" === t.method ? n.addEventListener("progress", t.progress) : /^(POST|PUT)$/i.test(t.method) && n.upload.addEventListener("progress", t.progress)), n.open(t.method, t.getUrl(), !0), t.timeout && (n.timeout = t.timeout), t.credentials === !0 && (n.withCredentials = !0), "responseType" in n && dt && (n.responseType = "blob"), t.headers.forEach(function (t, e) {
        ...
        function o(o) {
            return new e(function (e) {
                function s() {
                    r = i.pop(), a(r) ? r.call(t, o, c) : (n("Invalid interceptor of type " + typeof r + ", must be a function"), c())
                }

                function c(n) {
                    if (a(n)) u.unshift(n); else if (f(n))return u.forEach(function (e) {
                        n = d(n, function (n) {
                            return e.call(t, n) || n
                        })
                    }), void d(n, e);
    ...
    var bt = function (t, e) {
        ...
        this.url = n, this.ok = r >= 200 && r < 300, this.status = r || 0, this.statusText = i || "", this.headers = new vt(o), this.body = t, c(t) ? this.bodyText = t : h(t) && (this.bodyBlob = t, L(t) && (this.bodyText = H(t)))
    };
    bt.prototype.blob = function () {
        return d(this.bodyBlob)
    }, bt.prototype.text = function () {
        return d(this.bodyText)
    }, bt.prototype.json = function () {
        return d(this.text(), function (t) {
            return JSON.parse(t)
        })
    };
    var gt = function (t) {
        this.body = null, this.params = {}, et(this, t, {method: s(t.method || "GET")}), this.headers instanceof vt || (this.headers = new vt(this.headers))
    };
    gt.prototype.getUrl = function () {
        ...
        return new bt(t, et(e || {}, {url: this.getUrl()}))
    };
    var wt = {"X-Requested-With": "XMLHttpRequest"}, Tt = {Accept: "application/json, text/plain, */*"}, xt = {"Content-Type": "application/json;charset=utf-8"};
    return B.options = {}, B.headers = {
        ...
        custom: wt,
        common: Tt
    }, B.interceptors = [pt, ht, ct, ft, lt, st], ["get", "delete", "head", "jsonp"].forEach(function (t) {
        B[t] = function (e, n) {
